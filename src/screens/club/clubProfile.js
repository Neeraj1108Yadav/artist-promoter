...
<ScrollView style={{flex:1,backgroundColor:'#000000'}}>
        ...
        <View style={{flex:1,flexDirection:'column',backgroundColor:'#000000',marginTop:54,marginBottom:15}}>
      ...
      <View style={{flexDirection:'row',margin:10}}>
         ...
         <View style={{flexDirection:'row',
          ...
          <Image style={styles.imageCircle}
                 source={require('./imagesClub/d3.jpeg')}
                 flexBasis="35%"/> 
         ...
         <Image style={{height:24,width:24,marginRight:20}}
                         source={require('./imagesClub/edit.png')}/> 
...
{/* //============================= IMAGES ==========================================// */}
          ...
          <Image style={styles.userImages}
                 source={require('./imagesClub/d2.jpeg')}/>

          <Image style={styles.userImages}
                 source={require('./imagesClub/d3.jpeg')}/>

          <Image style={styles.userImages}
                 source={require('./imagesClub/d4.jpeg')}/>
          ...
          <Image style={styles.userImages}
                 source={require('./imagesClub/d5.jpeg')}/>

          <Image style={styles.userImages}
                 source={require('./imagesClub/d6.jpeg')}/>
