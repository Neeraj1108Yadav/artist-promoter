...
export default class SubCategory_Two extends Component{
      ...
      return(
       <View style={{backgroundColor:'#000000',flex:1,flexDirection:'column'}}>
        ...
        <ScrollView>
         ...
         <Text style={style.viewImages}>What do you perform ?</Text>
         ...
         <Text style={style.textSubCategory}>LOREM</Text>
          ...
          <View style={style.viewButton}>
           ...
           onPress = {() => this.props.navigation.navigate('FbTweetScreen')}>
