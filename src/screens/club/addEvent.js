    ...
    render()
    {
      return(
        ...
        <View style={{flex:1,flexDirection:'column',backgroundColor:'#000000'}}>
          ...
          <Image style={{ width: 24, height: 24}} source={require('./imagesClub/menu.png')}/> 
          <Text style={{fontSize:18,color:'#ffffff',fontWeight:'bold'}}> DATSPOT </Text>
          <Image style={{ width: 24, height: 24}} source={require('./imagesClub/notification.png')}/>
           ...
           <View style={{flexDirection:'row', 
               ...
               <TextInput style = {styles.textEdittextTime}
                ...
                <Image style={styles.imageClock}                               
                       source={require('./imagesClub/clock.png')}/> 
